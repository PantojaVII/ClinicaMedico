...
<body>
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <div class="collapse navbar-collapse main-menu-item justify-content-center"
                            ...
                            <ul class="navbar-nav align-items-center">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#.html">Quem somo</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                 ...
                                 <li class="nav-item">
                                    <a class="nav-link" href="login.html">Sou Paciente</a>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="col-lg-5 col-xl-5">
                    <div class="banner_text">
                        <div class="banner_text_iner">
                            ...
                            <h1>Um título &
                                Qualquer coisa</h1>
                            <p>Um texto de qualquer escolha</p>
                            <a href="#" class="btn_2">Botão de navegação</a>
            ...
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-md-6 col-lg-5">
                    <div class="about_us_text">
                        <h2>Quem somos</h2>
                        <p>Coloque uma breve apresentação sobre você</p>
    ...
    <section class="doctor_part section_padding">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-8">
                    <div class="section_tittle text-center">
                        <h2> Médicos Experientes</h2>
                        <p>Sabemos que saúde é assunto sério, por isso escolhemos os melhores</p>
                    </div>
                </div>
            </div>
            <div class="row">
 ...
 Desenvolvido Por | Pantoja <a href="https://colorlib.com" target="_blank"> </a>&copy;<script>document.write(new Date().getFullYear());</script>
                    ...
                    <div class="col-lg-4 col-md-12 text-center text-lg-right footer-social">
                        ...
                        <a href="#"><i class="ti-cell"></i></a>
                        <a href="loginadm.php"><i class="ti-user"></i></a>
